...
const router = new vue_router__WEBPACK_IMPORTED_MODULE_3__.default({
    mode: ((_a = process.env) === null || _a === void 0 ? void 0 : _a.docs) ? 'hash' : 'history',
    routes: [
